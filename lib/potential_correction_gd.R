# Initial try:data(grady_augmented) # an english dictionary
# Associated Press Data is contained in the R package "topicmodels"
# library(topicmodels)
# library(tm)
# data("AssociatedPress")
# ap_dict <- Terms(AssociatedPress) # Captures the unique words in AP

### This function is finding the potential candidates based on ground truth

load("../output/ground_truth_frequency.RData")
gd_tokens <- ground_truth_freq$tokens
